...
public class CustomerAuthorizeConfigProvider implements AuthorizeConfigProvider {
	...
	public boolean config(ExpressionUrlAuthorizationConfigurer<HttpSecurity>.ExpressionInterceptUrlRegistry config) {
		...
		"/webjars/springfox-swagger-ui/**","/v2/api-docs", "/user/**","/rokid/**","/oauthclient/**","/test/**","/refreshconfig/**","/tmall2/**","/tmall/**","/view/**","/PrivacyPolicyCN.html","PrivacyPolicyEN.html","/html/**","/hotelweb/**").permitAll();
		return false;
	}
