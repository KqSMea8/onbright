...
public class FacadeController extends BaseController {
					...
					for (SceneActionDTO sceneActionDTO : tActionDTOs) {
						...
						for (TSceneAction tSceneAction : dbActions) {
							if (sceneActionDTO.getNodeType().equals(NodeTypeEnum.single.getValue())
								...
								if (!StringUtils.isEmpty(sceneActionDTO.getGroupId())
										&& Integer.parseInt(sceneActionDTO.getGroupId()) != 0) {
									ResponseObject<TServerGroup> groupRes = feignDeviceClient.queryGroupByUserAndGroup(
											resUser.getData().getId(), Integer.parseInt(sceneActionDTO.getGroupId()));
									if (groupRes != null)
										tServerGroup = groupRes.getData();
								} else {
									if (!StringUtils.isEmpty(sceneActionDTO.getOboxSerialId())
											&& !StringUtils.isEmpty(sceneActionDTO.getOboxGroupAddr())) {

									}
								}
								if (tServerGroup != null) {
									if (tServerGroup.getId().intValue() == Integer
											.parseInt(tSceneAction.getActionid())) {
										if (!tSceneAction.getAction().equals(sceneActionDTO.getAction())) {
											sceneActionDTO.setActionType(2);
											needDTOs.add(sceneActionDTO);
										}
	...
	public ResponseObject<Map<String, Object>> readAliDevice(@PathVariable(value = "functionId") String functionId,
		...
		try {
			...
			ResponseObject aliRes = feignAliClient.readAliDevice(functionId, deviceId);
			com.alibaba.fastjson.JSONArray jsonArray = com.alibaba.fastjson.JSONArray
					.parseArray((String) aliRes.getData());
	...
	public ResponseObject setAliCountdown(@PathVariable(value = "deviceId") String deviceId,
		...
		try {
			...
			// feignAliClient.setAliCountdown(deviceId, command, timer,
			// timerValue);
	...
	@ApiOperation(value = "setAliTimer", httpMethod = "POST", produces = "application/json")
	@ApiResponse(code = 200, message = "success", response = ResponseObject.class)
	@RequestMapping(value = "/setAliTimer", method = RequestMethod.POST)
	public ResponseObject<Map<String, Object>> setAliTimer(@RequestParam(value = "deviceId") String deviceId,
			@RequestParam(value = "command") String command, @RequestParam(value = "timer") String timer,
			@RequestBody Object timerValue, @RequestParam(value = "timerId") String timerId) {
		ResponseObject<Map<String, Object>> res = new ResponseObject<Map<String, Object>>();
		try {
			UserDetails principal = (UserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
			if (StringUtils.isEmpty(principal.getUsername())) {
			...
			feignAliClient.setAliTimer(deviceId);
			TAliDevTimer aliDevTimer;
			Map<String, Object> map = new HashMap<String, Object>();
			ResponseObject aldRes;
			switch (TimerSetTypeEnum.getSetType(command)) {
			case add:
				// aldRes =
				// feignAliClient.getAliDevTimerByDeviceSerialIdAndCountDown(deviceId);
				// map = (Map<String,Object>)aldRes.getData();
				// if(map !=null){
				// feignAliClient.delAliDevTimerByDeviceSerialId(Integer.valueOf(map.get("id").toString()));
				// feignQuartzClient.deleteJob(map.get("id").toString());
				...
				aliDevTimer.setTimer(timer);
				aliDevTimer.setDeviceSerialId(deviceId);
				aliDevTimer.setTimerValue(timerValue.toString());
				aliDevTimer.setIsCountdown(0);
				aliDevTimer.setState(1);
				ResponseObject addRes = feignAliClient.addAliDevTimer(aliDevTimer);
				int repId = (Integer) addRes.getData();
				feignQuartzClient.startTimerSchedule(repId, timer);
			...
			case enable:
				...
				map = (Map<String, Object>) aldRes.getData();
				aliDevTimer = new TAliDevTimer();
				aliDevTimer.setDeviceSerialId(map.get("deviceSerialId").toString());
				aliDevTimer.setIsCountdown(Integer.valueOf(map.get("isCountdown").toString()));
				aliDevTimer.setTimer(map.get("timer").toString());
				aliDevTimer.setTimerValue(map.get("timerValue").toString());
				aliDevTimer.setLastOpTime(new Date());
	...
	@ApiOperation(value = "delAliDevice", httpMethod = "POST", produces = "application/json")
	@ApiResponse(code = 200, message = "success", response = ResponseObject.class)
	@RequestMapping(value = "/delAliDevice", method = RequestMethod.POST)
	public ResponseObject<Map<String, Object>> delAliDevice(@RequestParam(value = "deviceId") String deviceId) {
		ResponseObject<Map<String, Object>> res = new ResponseObject<Map<String, Object>>();
		try {
			UserDetails principal = (UserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
			if (StringUtils.isEmpty(principal.getUsername())) {
			...
			feignAliClient.delAliDevice(deviceId);
			res.setStatus(ResponseEnum.SelectSuccess.getStatus());
			res.setMessage(ResponseEnum.SelectSuccess.getMsg());
		} catch (Exception e) {
			logger.error("===error msg:" + e.getMessage());
	...
	@ApiOperation(value = "queryCountDown", httpMethod = "GET", produces = "application/json")
	@ApiResponse(code = 200, message = "success", response = ResponseObject.class)
	@RequestMapping(value = "/queryCountDown/{deviceId}", method = RequestMethod.GET)
	public ResponseObject<Map<String, Object>> queryCountDown(@PathVariable(value = "deviceId") String deviceId) {
		ResponseObject res = new ResponseObject();
		try {
			UserDetails principal = (UserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
			if (StringUtils.isEmpty(principal.getUsername())) {
			...
			ResponseObject alires = feignAliClient.queryCountDown(deviceId);
	...
	public ResponseObject<Map<String, Object>> getIrList(@RequestParam(required = true, value = "brandId") String brandId,
		...
		try {
			...
			res = feignAliClient.getIrList(brandId,deviceType);
	...
	@ApiOperation(value = "pairIrRemotecode", httpMethod = "POST", produces = "application/json")
	@ApiResponse(code = 200, message = "success", response = ResponseObject.class)
	@RequestMapping(value = "/pairIrRemotecode", method = RequestMethod.POST)
	public ResponseObject<Map<String, Object>> pairIrRemotecode(@RequestParam(required = true, value = "brandId") String brandId,
	...
	@ApiOperation(value = "deleteIrDevice", httpMethod = "POST", produces = "application/json")
	@ApiResponse(code = 200, message = "success", response = ResponseObject.class)
	@RequestMapping(value = "/deleteIrDevice", method = RequestMethod.POST)
	public ResponseObject<Map<String, Object>> deleteIrDevice(@RequestParam(required = true, value = "serialId") String serialId,
		...
		try {
			...
			feignAliClient.deleteIrDevice(serialId,index);
			res.setStatus(ResponseEnum.SelectSuccess.getStatus());
			res.setMessage(ResponseEnum.SelectSuccess.getMsg());
		} catch (Exception e) {
			logger.error("===error msg:" + e.getMessage());
	...
	@ApiOperation(value = "deleteIrDeviceKey", httpMethod = "POST", produces = "application/json")
	@ApiResponse(code = 200, message = "success", response = ResponseObject.class)
	@RequestMapping(value = "/deleteIrDeviceKey", method = RequestMethod.POST)
	public ResponseObject<Map<String, Object>> deleteIrDeviceKey(@RequestParam(required = true, value = "serialId") String serialId,
																 @RequestParam(required = true, value = "index") String index,
																 @RequestParam(required = true, value = "key") String key,
		...
		try {
			...
			res = feignAliClient.deleteIrDeviceKey(serialId,index,key,keyType);
	...
	@ApiOperation(value = "getIrTypeList", httpMethod = "POST", produces = "application/json")
	@ApiResponse(code = 200, message = "success", response = ResponseObject.class)
	@RequestMapping(value = "/getIrTypeList", method = RequestMethod.POST)
	public ResponseObject<Map<String, Object>> getIrTypeList() {
		ResponseObject<Map<String, Object>> res = new ResponseObject<Map<String, Object>>();
		try {
			UserDetails principal = (UserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
			if (StringUtils.isEmpty(principal.getUsername())) {
			...
			res = feignAliClient.getIrTypeList();
		} catch (Exception e) {
			logger.error("===error msg:" + e.getMessage());
			res.setStatus(ResponseEnum.Error.getStatus());
			res.setMessage(ResponseEnum.Error.getMsg());
	...
	@ApiOperation(value = "getIrBrandList", httpMethod = "POST", produces = "application/json")
	@ApiResponse(code = 200, message = "success", response = ResponseObject.class)
	@RequestMapping(value = "/getIrBrandList", method = RequestMethod.POST)
	public ResponseObject<Map<String, Object>> getIrBrandList(@RequestParam(required = true, value = "deviceType") String deviceType) {
		...
		try {
			...
			res = feignAliClient.getIrBrandList(deviceType);
		} catch (Exception e) {
			logger.error("===error msg:" + e.getMessage());
			res.setStatus(ResponseEnum.Error.getStatus());
			res.setMessage(ResponseEnum.Error.getMsg());
	...
	@ApiOperation(value = "bindIrRemotecode", httpMethod = "POST", produces = "application/json")
	@ApiResponse(code = 200, message = "success", response = ResponseObject.class)
	@RequestMapping(value = "/bindIrRemotecode", method = RequestMethod.POST)
	public ResponseObject<Map<String, Object>> bindIrRemotecode(@RequestParam(required = true, value = "brandId") String brandId,
																@RequestParam(required = true, value = "deviceType") String deviceType,
		...
		try {
			...
			res = feignAliClient.bindIrRemotecode(brandId,deviceType,remoteId,name,serialId);
		} catch (Exception e) {
			logger.error("===error msg:" + e.getMessage());
			res.setStatus(ResponseEnum.Error.getStatus());
			res.setMessage(ResponseEnum.Error.getMsg());
	...
	public ResponseObject<Map<String, Object>> learnIrDeviceKey(@RequestParam(required = true, value = "serialId") String serialId,
																@RequestParam(required = true, value = "index") String index,
																@RequestParam(required = true, value = "keyType") String keyType,
																@RequestParam(required = true, value = "key") String key,
																@RequestParam(required = true, value = "timeout") String timeout) {
    ...
    //获取红外遥控方案
    @ApiOperation(value = "queryIrDevice", httpMethod = "POST", produces = "application/json")
    @ApiResponse(code = 200, message = "success", response = ResponseObject.class)
    @RequestMapping(value = "/queryIrDevice", method = RequestMethod.POST)
    public ResponseObject<Map<String, Object>> queryIrDevice(@RequestParam(required = true, value = "serialId") String serialId) {
        ResponseObject<Map<String, Object>> res = new ResponseObject<Map<String, Object>>();
        try {
            UserDetails principal = (UserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
            if (StringUtils.isEmpty(principal.getUsername())) {
    ...
    //获取红外遥控方案
    @ApiOperation(value = "renameIrDevice", httpMethod = "POST", produces = "application/json")
    @ApiResponse(code = 200, message = "success", response = ResponseObject.class)
    @RequestMapping(value = "/renameIrDevice", method = RequestMethod.POST)
    public ResponseObject<Map<String, Object>> renameIrDevice(@RequestParam(required = true, value = "serialId") String serialId,
                                                              @RequestParam(required = true, value = "index") String index,
                                                              @RequestParam(required = true, value = "name") String name) {
        ResponseObject<Map<String, Object>> res = new ResponseObject<Map<String, Object>>();
        try {
	 ...
	 * @Description:  
	 */
	public ResponseObject deleteDeviceLocation(String serialId, int parseInt, int parseInt2, int parseInt3,
			String action) {
	...
	@ApiResponse(code = 200, message = "success", response = ResponseObject.class)
	@RequestMapping(value = "/updateLocation/{location}", method = RequestMethod.PUT)
