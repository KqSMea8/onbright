...
public class HystrixFeignAli2Fallback extends BasicHystrixFeignFallback implements FeignAliClient {
	...
	@Override
	public ResponseObject localIrDeviceDownload(Integer index, Integer timeout, String serialId) {
		logger.warn("===ali server is break===");
		return serverError();
	}

	@Override
	public ResponseObject localIrDeviceDelete(Integer index, String serialId) {
		logger.warn("===ali server is break===");
		return serverError();
	}

	@Override
	public ResponseObject irDownLoad(Integer index, String serialId,Integer codeIndex) {
		logger.warn("===ali server is break===");
		return serverError();
	}
