...
public class HystrixFeignDeviceFallback extends BasicHystrixFeignFallback implements FeignDeviceClient {
	...
	/* (non-Javadoc)  
	 * @see com.bright.apollo.feign.FeignDeviceClient#addDeviceLocation(java.lang.String, java.lang.Integer, java.lang.Integer, java.lang.Integer)  
	 */
	@SuppressWarnings("unchecked")
	@Override
	...
	/* (non-Javadoc)  
	 * @see com.bright.apollo.feign.FeignDeviceClient#queryLocation(java.lang.Integer)  
	 */
	@SuppressWarnings("unchecked")
	@Override
