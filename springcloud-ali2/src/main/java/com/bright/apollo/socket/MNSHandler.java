...
public class MNSHandler {
	...
	public CloudQueue getCloudQueue() {
		CloudAccount account = new CloudAccount(iotOboxConncetion.getAccessKeyId(), iotOboxConncetion.getAccessKeySecret(), iotOboxConncetion.getEndPoint());
		MNSClient client = account.getMNSClient();
		return client.getQueueRef(iotOboxConncetion.getOboxSouthChinaUrl());
	}
