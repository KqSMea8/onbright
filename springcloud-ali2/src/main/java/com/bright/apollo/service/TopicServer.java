...
//        String mString = com.bright.apollo.tool.StringUtils.bytes2String(cmd,data,packageLength,head);
    ...
    public void pubTopicDev(JSONObject object, String productKey, String deviceName, AliRegionEnum eAliRegionEnum) throws Exception{
...
//        String mString = com.bright.apollo.tool.StringUtils.bytes2String(cmd, data,packageLength,head);
    ...
    public JSONObject requestDev(JSONObject object,String deviceSerial) throws Exception{
        ...
        logger.info(" TopicService.requestDev() productkey: " + productKey + " devicename:" + deviceName +" object: "  + object.toString() );
        ...
        /*if (eAliRegionEnum.equals(AliRegionEnum.AMERICA)) {
            ...
            rrpcResponse = iotClient.getClient(AliRegionEnum.SOURTHCHINA.name()).getAcsResponse(rrpcRequest);
        }*/
