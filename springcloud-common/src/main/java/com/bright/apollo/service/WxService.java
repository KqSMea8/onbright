...
public interface WxService {
	...
	static final String WX_TOKEN_URL="https://api.weixin.qq.com/sns/oauth2/access_token?appid="+Constant.WX_APPID+"&secret="+Constant.WX_SECRET+"CODE&grant_type=authorization_code&code=";
