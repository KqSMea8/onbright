...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// .and()
		// .addFilterAfter(new
		// AfterLoginFilter(),UsernamePasswordAuthenticationFilter.class);
		// .successForwardUrl("/aouth2/sendRedirect")

		// .and()
		// .addFilterBefore(new BeforeLoginFilter(),
	...
	// ServletException {
	// logger.info("This is a filter after
	...
	// OAuth2Authentication defaultOAuth2AccessToken =
	// redisBussines.getObject("auth:"+accessToken,OAuth2Authentication.class);
	...
	// redisBussines.setValueWithExpire("appkey_userId"+userId,appKey,60 * 60 *
	// 24 * 7);
	// }else if(appKeyUserId !=null && appKey!=null &&
	// !appKeyUserId.equals(appKey)){
	...
	// redisBussines.setValueWithExpire("appkey_userId"+userId,appKeyUserIdArr[i]+":"+appKey,60
	// * 60 * 24 * 7);
	// }
	// }
	// logger.info("------ appKeyUserId =======
	// "+redisBussines.get("appkey_userId"+userId));
	//
	// }
